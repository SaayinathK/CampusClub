              ...
              <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
                ...
                {!myParticipant ? (
                  ...
                  <div className="space-y-4">
                    {/* Status badge */}
                    {paymentCfg && (
                      <div className={`flex items-center gap-2 px-4 py-3 rounded-xl bg-${paymentCfg.color}-500/10 border border-${paymentCfg.color}-500/20 text-${paymentCfg.color}-400 text-xs font-black uppercase tracking-widest`}>
                        {paymentCfg.icon}
                        {paymentCfg.label}
                      </div>
                    )}
                    ...
                    {myParticipant.attended && (
                      <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-black uppercase tracking-widest">
